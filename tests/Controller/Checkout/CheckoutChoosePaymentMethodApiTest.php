...
EOT;
        ...
        $this->client->request('PUT', $this->getPaymentUrl($token) . '/0', [], [], self::CONTENT_TYPE_HEADER, $data);
...
EOT;
        ...
        $this->client->request('PUT', sprintf('/shop-api/SPACE_KLINGON/checkout/%s/payment/0', $token), [], [], self::CONTENT_TYPE_HEADER, $data);
