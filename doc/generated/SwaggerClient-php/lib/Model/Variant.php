...
class Variant implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['name_axis'] = isset($data['name_axis']) ? $data['name_axis'] : null;
     ...
     * Sets axis
     *
     * @param string[] $axis List of codes of associated product options.
     *
     * @return $this
     */
     ...
     */
    public function getNameAxis()
    {
        return $this->container['name_axis'];
    }

    /**
     * Sets name_axis
     *
     * @param map[string,string] $name_axis Map of keys from previous field to translated values of given variant.
     *
     * @return $this
     */
    public function setNameAxis($name_axis)
    {
        $this->container['name_axis'] = $name_axis;
