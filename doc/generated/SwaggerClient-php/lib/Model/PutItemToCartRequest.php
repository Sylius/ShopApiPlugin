...
/**
 * PutItemToCartRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PutItemToCartRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PutItemToCartRequest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['variant_code'] = isset($data['variant_code']) ? $data['variant_code'] : null;
    ...
    public function setQuantity($quantity)
    {
        ...
        if (!is_null($quantity) && ($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling PutItemToCartRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets variant_code
     *
     * @param string $variant_code variant_code
     *
     * @return $this
     */
     ...
     * Sets options
     *
     * @param map[string,string] $options Keys reference to the code of an option and values to the code of option value.
     *
     * @return $this
     */
